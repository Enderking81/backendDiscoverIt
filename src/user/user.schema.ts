...
const ERR_NICK_LEN = `Nickname must be ${NICK_LEN_MIN} to ${NICK_LEN_MAX} characters long.`
const ERR_NICK_DOTS = 'Your nickname cannot start or end with a dot'
